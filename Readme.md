...
1. 먼저 한남이 강 위 원하는 위치에 다리를 세 개 놓습니다.
...
특수한 유닛을 제외한 모든 유닛은 상하좌우 한 칸씩만 이동이 가능하며, 대각선으로는 이동할 수 없습니다. 이동하고자 하는 칸에 자신의 유닛이 이미 있다면 그 칸으로는 이동할 수 없으며, 상대방의 유닛이 있다면 해당 유닛을 공격합니다.

게임보드 중앙인 5번째 행에는 강이 있습니다.
- 강이 있는 칸에는 유닛을 놓을 수 없지만, 강 위에 다리가 놓여 있는 칸에는 유닛을 놓을 수 있습니다.
- 다리가 놓여 있는 칸이 연속되어 있어도 다리에서 다른 다리로 이동할 수는 없습니다.

모든 유닛에는 공격력과 방어력이 존재합니다. 상대방의 유닛을 공격할 때는 해당 유닛을 직접 확인해 보고, 자신의 유닛의 공격력과 상대방 유닛의 방어력을 비교합니다. 이 때 다음과 같이 진행됩니다.
1. 내 유닛의 공격력이 상대방 유닛의 방어력보다 높을 때: 상대방 유닛은 게임에서 제외되고, 내 유닛은 상대방 유닛 위치로 이동합니다.
2. 내 유닛의 공격력이 상대방 유닛의 방어력보다 낮을 때: 내 유닛은 게임에서 제외되고, 상대방 유닛은 원래 위치에 그대로 놔둡니다.
3. 내 유닛의 공격력과 상대방 유닛의 방어력이 같을 때: 두 유닛 모두 게임에서 제외됩니다.

즉 어느 쪽에서 공격했든지간에 관계없이 공격력과 방어력을 비교해서 무조건 높은 쪽이 살아남게 됩니다. 하지만 공격한 쪽은 공격당한 상대방 유닛을 확인할 수 있습니다.
...
몇몇 유닛은 특수 능력이 있습니다.
- 대통령은 **전쟁 게-임**에서 유일하게 다리를 부술 수 있습니다. 대통령이 다리를 한 번도 건너지 않았다는 전제 하에, 한남 유닛이 다리 위에 있는 경우, [서울은 안전하기 때문에](https://namu.wiki/w/%EA%B5%AD%EB%AF%BC%20%EC%97%AC%EB%9F%AC%EB%B6%84%20%EC%95%88%EC%8B%AC%ED%95%98%EC%8B%AD%EC%8B%9C%EC%98%A4) 게임에서 1회에 한해 유닛과 다리를 한꺼번에 없앨 수 있습니다.
...
- 공병은 **전쟁 게-임**에서 유일하게 다리를 지을 수 있습니다. 강에 다리가 없는 칸의 바로 직전 칸에 공병이 위치할 경우, 한 턴을 소모하여 공병 다음 칸에 다리를 지을 수 있습니다.
...
- 장군은 수령이 게임에서 제외된 경우, 마찬가지로 두 칸을 이동할 수 있습니다. [수령~~님~~ 쓰시던 축지법 장군~~님~~이 쓰시기 때문입니다](https://namu.wiki/w/%EC%9E%A5%EA%B5%B0%EB%8B%98%20%EC%B6%95%EC%A7%80%EB%B2%95%20%EC%93%B0%EC%8B%A0%EB%8B%A4).
